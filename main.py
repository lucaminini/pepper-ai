...
headers = {
    ...
    "Authorization": "Bearer {}".format(OPENAI_API)
}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="10.20.17.46",
                        help="Robot IP address. On robot or Local Naoqi: use '10.20.17.46'.")
